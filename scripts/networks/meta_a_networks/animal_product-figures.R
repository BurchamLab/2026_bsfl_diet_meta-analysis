...
load("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_network_gen.RData")
...
base_path = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/"
...
cat("Greedy Modularity - animal_product Diet:", mod_greedy)

clust_coef = transitivity(graph, type = "global")

cat("Global Clustering Coefficient - animal_product Diet:", clust_coef)

avg_path_len = mean_distance(graph, directed = FALSE)

cat("Global Average Path Length - animal_product Diet:", avg_path_len)

global_betweenness = betweenness(graph, directed = FALSE, normalized = TRUE)

cat("Mean Global Betweenness - animal_product Diet:", mean(global_betweenness))

global_degree = degree(graph, normalized = TRUE)

cat("Mean Global Degree - animal_product Diet:", mean(global_degree))

global_closeness = closeness(graph, normalized = TRUE)

cat("Mean Global Closeness - animal_product Diet:", mean(global_closeness))

global_eigenvector = eigen_centrality(graph, directed = FALSE)$vector

cat("Mean Global Eigenvector - animal_product Diet:", mean(global_eigenvector))
...
cat("Central Nodes in animal_product Diet:", top_hubs, "\n")
cat("Central Edges in animal_product Diet:", edge_names, "\n")
...
write.table(cumulative_resilience_mod, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/modularity_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_bet, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/betweenness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_close, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/closeness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_deg, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/degree_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_eig, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/eigenvector_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
auc_animal_product = data.frame(Diet = "animal_product", 
...
write.table(auc_animal_product, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/metric_auc.tsv", sep = "\t", row.names = FALSE)

# Compute mean and 95% CI

ci_clust_mod = cumulative_resilience_random %>%
...
ci_clust_clus = cumulative_resilience_random %>%
  group_by(Percent_Removed) %>%
  summarize(
...
ci_clust_path = cumulative_resilience_random %>%
  group_by(Percent_Removed) %>%
  summarize(
    Mean  = mean(Avg_Path_Length, 0.975, na.rm = TRUE),
    Lower = quantile(Avg_Path_Length, 0.025, na.rm = TRUE),
    Upper = quantile(Avg_Path_Length, 0.975, na.rm = TRUE),
    .groups = "drop"
  )
...
write.table(auc_table, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/random_auc_table.tsv", sep = "\t", row.names = FALSE)
...
ggsave(
  "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_modularity_random_bootstrap.pdf",
  random_plot,
...
ggsave(
  "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_clus_coef_random_bootstrap.pdf",
  random_plot,
  height = 8, width = 10, units = "in"
)
...
random_plot = ggplot() +
  geom_line(
    data = cumulative_resilience_random,
    aes(x = Percent_Removed, y = Avg_Path_Length, group = Bootstrap),
    color = "gray",
    alpha = 0.4
  ) +
  geom_ribbon(
...
ggsave(
  "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_path_length_random_bootstrap.pdf",
  random_plot,
  height = 8, width = 10, units = "in"
)
...
ggplot(cumulative_resilience_bet, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_global_clust_coef_betweenness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_mod, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_global_clust_coef_modularity.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_deg, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_global_clust_coef_degree.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_eig, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_global_clust_coef_eigenvector.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_close, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_global_clust_coef_closeness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_components.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Components)) +
#   geom_line(color = "blue") +
#   labs(title = "Number of Components During Node Removal", x = "Step (Node Removal)", y = "Number of Components") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_components_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_avg_path_length.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   labs(title = "Average Path Length During Node Removal", x = "Step (Node Removal)", y = "Average Path Length") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_avg_path_length_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_global_clust_coef.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Clustering_Coeff)) +
#   geom_line(color = "green") +
#   labs(title = "Global Clustering Coefficient During Node Removal", x = "Step (Node Removal)", y = "Clustering Coefficient") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_global_clust_coef_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
cat("Robustness AUC - animal_product Diet (degree):", robustness_results_degree$Robustness_Index, "\n")
cat("Robustness AUC- animal_product Diet (betweenness):", robustness_results_betweenness$Robustness_Index, "\n")
...
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_robustness_analysis.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot() +
  ...
  labs(
    title = paste0("Random Removal Robustness Analysis animal_product Diet (Mean AUC: ", round(mean_auc, 4), ")"),
...
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_waste_random_removal_robustness.pdf", device = "pdf", width = 10, height = 8, units = "in")
...
base_path = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/feature_tables/animal_product/"
# base_path = "/Users/burchamlab/Library/CloudStorage/OneDrive-UniversityofTennessee/UTK/Research/Code/bsf_metaa/SparCC-master/animal_product/subsample/"
...
save.image("/lustre/isaac24/proj/UTK0406/ReeseSaho/test.RData")
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_study_network.pdf", width = 10, height = 8)
...
plot(graph,
     ...
     main = "Animal Product Correlation Network - Study Level"
)
...
if ("animal_product" == "plant_product" || "animal_product" == "plant_waste") {
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_diet_network.pdf", width = 10, height = 8)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Animal Product Correlation Network - Diet Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_cluster_network_core_nodes.pdf", width = 12, height = 8)
...
plot(comm_greedy, graph,
     ...
     main = "Animal Product Correlation Network",
     edge.color = "gray")
...
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_cluster_network_top_hubs.pdf", width = 8, height = 8)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_ASV_network.pdf", width = 18, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Animal Product Correlation Network - ASV Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_genus_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Animal Product Correlation Network - Genus Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_family_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Animal Product Correlation Network - Family Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_order_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Animal Product Correlation Network - Order Level"
)
...
class_list = sort(unique(V(graph)$class_name))

# Put Unknown last if present

if ("Unknown" %in% class_list) {
  class_list = c(setdiff(class_list, "Unknown"), "Unknown")
}

legend_colors = sep.table_full$Class_color[
  match(class_list, sep.table_full$Class)
]
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_class_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Animal Product Correlation Network - Class Level",
     font.main = 1,
     cex.main = 1.2   
)

legend("topright", legend = legend_labels, fill = legend_colors, border = "black", cex = 0.7)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_phylum_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Animal Product Correlation Network - Phylum Level"
)
...
write.table(vertices_df_clean, file = file.path("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_vertices.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)


# Edges
edges_df <- igraph::as_data_frame(graph, what = "edges")
write.table(edges_df, file = file.path("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_edges.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)

save.image("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/animal_product/animal_product_figures_gen.RData")
