...
load("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_network_gen.RData")
...
base_path = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/"
...
cat("Greedy Modularity - variable Diet:", mod_greedy)

clust_coef = transitivity(graph, type = "global")

cat("Global Clustering Coefficient - variable Diet:", clust_coef)

avg_path_len = mean_distance(graph, directed = FALSE)

cat("Global Average Path Length - variable Diet:", avg_path_len)

global_betweenness = betweenness(graph, directed = FALSE, normalized = TRUE)

cat("Mean Global Betweenness - variable Diet:", mean(global_betweenness))

global_degree = degree(graph, normalized = TRUE)

cat("Mean Global Degree - variable Diet:", mean(global_degree))

global_closeness = closeness(graph, normalized = TRUE)

cat("Mean Global Closeness - variable Diet:", mean(global_closeness))

global_eigenvector = eigen_centrality(graph, directed = FALSE)$vector

cat("Mean Global Eigenvector - variable Diet:", mean(global_eigenvector))
...
cat("Central Nodes in variable Diet:", top_hubs, "\n")
cat("Central Edges in variable Diet:", edge_names, "\n")
...
write.table(cumulative_resilience_mod, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/modularity_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_bet, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/betweenness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_close, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/closeness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_deg, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/degree_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_eig, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/eigenvector_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
auc_mixed_product = data.frame(Diet = "variable", 
...
write.table(auc_mixed_product, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/metric_auc.tsv", sep = "\t", row.names = FALSE)
...
write.table(auc_table, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/random_auc_table.tsv", sep = "\t", row.names = FALSE)
...
ggsave(
  "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_Modularity_random_bootstrap.pdf",
  random_plot,
...
ggplot(cumulative_resilience_bet, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_global_clust_coef_betweenness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_mod, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_global_clust_coef_modularity.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_deg, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_global_clust_coef_degree.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_eig, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_global_clust_coef_eigenvector.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_close, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_global_clust_coef_closeness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
cat("Robustness AUC - variable Diet (degree):", robustness_results_degree$Robustness_Index, "\n")
cat("Robustness AUC- variable Diet (betweenness):", robustness_results_betweenness$Robustness_Index, "\n")
...
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_robustness_analysis.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot() +
  ...
  labs(
    title = paste0("Random Removal Robustness Analysis variable Diet (Mean AUC: ", round(mean_auc, 4), ")"),
...
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_waste_random_removal_robustness.pdf", device = "pdf", width = 10, height = 8, units = "in")
...
base_path = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/feature_tables/variable/"
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_study_network.pdf", width = 10, height = 8)
...
if ("variable" == "plant_product" || "variable" == "plant_waste") {
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_diet_network.pdf", width = 10, height = 8)
...
core_nodes = c("edcd7e450f5048f455fdbce78df1a8a3",
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_cluster_network_core_nodes.pdf", width = 12, height = 8)
...
plot(comm_greedy, graph,
     ...
     main = "variable Correlation Network",
     edge.color = "gray")
...
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_cluster_network_top_hubs.pdf", width = 8, height = 8)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_ASV_network.pdf", width = 18, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_genus_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/variable/variable_family_network.pdf", width = 14, height = 10)
