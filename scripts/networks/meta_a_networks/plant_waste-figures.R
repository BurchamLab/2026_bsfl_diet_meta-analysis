...
load("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_network_gen.RData")
...
base_path = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/"
...
cat("Greedy Modularity - plant_waste Diet:", mod_greedy)

clust_coef = transitivity(graph, type = "global")

cat("Global Clustering Coefficient - plant_waste Diet:", clust_coef)

avg_path_len = mean_distance(graph, directed = FALSE)

cat("Global Average Path Length - plant_waste Diet:", avg_path_len)

global_betweenness = betweenness(graph, directed = FALSE, normalized = TRUE)

cat("Mean Global Betweenness - plant_waste Diet:", mean(global_betweenness))

global_degree = degree(graph, normalized = TRUE)

cat("Mean Global Degree - plant_waste Diet:", mean(global_degree))

global_closeness = closeness(graph, normalized = TRUE)

cat("Mean Global Closeness - plant_waste Diet:", mean(global_closeness))

global_eigenvector = eigen_centrality(graph, directed = FALSE)$vector

cat("Mean Global Eigenvector - plant_waste Diet:", mean(global_eigenvector))
...
cat("Central Nodes in plant_waste Diet:", top_hubs, "\n")
cat("Central Edges in plant_waste Diet:", edge_names, "\n")
...
write.table(cumulative_resilience_mod, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/modularity_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_bet, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/betweenness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_close, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/closeness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_deg, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/degree_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_eig, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/eigenvector_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
auc_plant_waste = data.frame(Diet = "plant_waste", 
...
write.table(auc_plant_waste, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/metric_auc.tsv", sep = "\t", row.names = FALSE)
...
write.table(auc_table, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/random_auc_table.tsv", sep = "\t", row.names = FALSE)
...
ggsave(
  "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_modularity_random_bootstrap.pdf",
  random_plot,
...
ggsave(
  "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_clus_coef_random_bootstrap.pdf",
  random_plot,
  height = 8, width = 10, units = "in"
)
...
ggsave(
  "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_path_length_random_bootstrap.pdf",
  random_plot,
  height = 8, width = 10, units = "in"
)
...
ggplot(cumulative_resilience_bet, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_global_clust_coef_betweenness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_mod, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_global_clust_coef_modularity.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_deg, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_global_clust_coef_degree.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_eig, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_global_clust_coef_eigenvector.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_close, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_global_clust_coef_closeness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_components.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Components)) +
#   geom_line(color = "blue") +
#   labs(title = "Number of Components During Node Removal", x = "Step (Node Removal)", y = "Number of Components") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_components_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_avg_path_length.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   labs(title = "Average Path Length During Node Removal", x = "Step (Node Removal)", y = "Average Path Length") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_avg_path_length_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_global_clust_coef.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Clustering_Coeff)) +
#   geom_line(color = "green") +
#   labs(title = "Global Clustering Coefficient During Node Removal", x = "Step (Node Removal)", y = "Clustering Coefficient") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_global_clust_coef_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
cat("Robustness AUC - plant_waste Diet (degree):", robustness_results_degree$Robustness_Index, "\n")
cat("Robustness AUC- plant_waste Diet (betweenness):", robustness_results_betweenness$Robustness_Index, "\n")
...
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_robustness_analysis.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot() +
  ...
  labs(
    title = paste0("Random Removal Robustness Analysis plant_waste Diet (Mean AUC: ", round(mean_auc, 4), ")"),
...
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_waste_random_removal_robustness.pdf", device = "pdf", width = 10, height = 8, units = "in")
...
base_path = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/feature_tables/plant_waste/"
# base_path = "/Users/burchamlab/Library/CloudStorage/OneDrive-UniversityofTennessee/UTK/Research/Code/bsf_metaa/SparCC-master/plant_waste/subsample/"
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_study_network.pdf", width = 10, height = 8)
...
plot(graph,
     ...
     main = "Plant Waste Correlation Network - Study Level"
)
...
if ("plant_waste" == "plant_product" || "plant_waste" == "plant_waste") {
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_diet_network.pdf", width = 10, height = 8)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Plant Waste Correlation Network - Diet Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_cluster_network_core_nodes.pdf", width = 12, height = 8)
...
plot(comm_greedy, graph,
     ...
     main = "Plant Waste Correlation Network",
     edge.color = "gray")
...
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_cluster_network_top_hubs.pdf", width = 8, height = 8)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_ASV_network.pdf", width = 18, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Plant Waste Correlation Network - ASV Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_genus_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Plant Waste Correlation Network - Genus Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_family_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Plant Waste Correlation Network - Family Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_order_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Plant Waste Correlation Network - Order Level"
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_class_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Plant Waste Correlation Network - Class Level",
     font.main = 1,
     cex.main = 1.2   
)
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_phylum_network.pdf", width = 14, height = 10)
...
plot(graph,
     ...
     edge.color = "darkgrey",
     vertex.label.cex = 0.35,
     main = "Plant Waste Correlation Network - Phylum Level"
)
...
write.table(vertices_df_clean, file = file.path("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_vertices.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)


# Edges
edges_df <- igraph::as_data_frame(graph, what = "edges")
write.table(edges_df, file = file.path("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_edges.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)

save.image("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/meta_a_networks/plant_waste/plant_waste_figures_gen.RData")
