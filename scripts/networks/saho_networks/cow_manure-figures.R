...
load("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_network_gen.RData")
...
base_path = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/"
...
cat("Greedy Modularity - cow_manure Diet:", mod_greedy)

clust_coef = transitivity(graph, type = "global")

cat("Global Clustering Coefficient - cow_manure Diet:", clust_coef)

avg_path_len = mean_distance(graph, directed = FALSE)

cat("Global Average Path Length - cow_manure Diet:", avg_path_len)

global_betweenness = betweenness(graph, directed = FALSE, normalized = TRUE)

cat("Mean Global Betweenness - cow_manure Diet:", mean(global_betweenness))

global_degree = degree(graph, normalized = TRUE)

cat("Mean Global Degree - cow_manure Diet:", mean(global_degree))

global_closeness = closeness(graph, normalized = TRUE)

cat("Mean Global Closeness - cow_manure Diet:", mean(global_closeness))

global_eigenvector = eigen_centrality(graph, directed = FALSE)$vector

cat("Mean Global Eigenvector - cow_manure Diet:", mean(global_eigenvector))
...
cat("Central Nodes in cow_manure Diet:", top_hubs, "\n")
cat("Central Edges in cow_manure Diet:", edge_names, "\n")
...
write.table(cumulative_resilience_mod, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/modularity_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_bet, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/betweenness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_close, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/closeness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_deg, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/degree_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_eig, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/eigenvector_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
auc_cow_manure = data.frame(Diet = "cow_manure", 
...
write.table(auc_cow_manure, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/metric_auc.tsv", sep = "\t", row.names = FALSE)
...
write.table(auc_table, file = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/random_auc_table.tsv", sep = "\t", row.names = FALSE)
...
ggsave(
  "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_Modularity_random_bootstrap.pdf",
  random_plot,
...
ggplot(cumulative_resilience_bet, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_global_clust_coef_betweenness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_mod, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_global_clust_coef_modularity.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_deg, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_global_clust_coef_degree.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_eig, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_global_clust_coef_eigenvector.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_close, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_global_clust_coef_closeness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_components.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Components)) +
#   geom_line(color = "blue") +
#   labs(title = "Number of Components During Node Removal", x = "Step (Node Removal)", y = "Number of Components") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_components_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_avg_path_length.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   labs(title = "Average Path Length During Node Removal", x = "Step (Node Removal)", y = "Average Path Length") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_avg_path_length_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_global_clust_coef.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Clustering_Coeff)) +
#   geom_line(color = "green") +
#   labs(title = "Global Clustering Coefficient During Node Removal", x = "Step (Node Removal)", y = "Clustering Coefficient") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_global_clust_coef_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
cat("Robustness AUC - cow_manure Diet (degree):", robustness_results_degree$Robustness_Index, "\n")
cat("Robustness AUC- cow_manure Diet (betweenness):", robustness_results_betweenness$Robustness_Index, "\n")
...
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_robustness_analysis.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot() +
  ...
  labs(
    title = paste0("Random Removal Robustness Analysis cow_manure Diet (Mean AUC: ", round(mean_auc, 4), ")"),
...
ggsave(filename = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_waste_random_removal_robustness.pdf", device = "pdf", width = 10, height = 8, units = "in")
...
base_path = "/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/feature_tables/cow_manure/"
# base_path = "/Users/burchamlab/Library/CloudStorage/OneDrive-UniversityofTennessee/UTK/Research/Code/bsf_metaa/SparCC-master/cow_manure/subsample/"
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_study_network.pdf", width = 10, height = 8)
...
if ("cow_manure" == "plant_product" || "cow_manure" == "plant_waste") {
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_diet_network.pdf", width = 10, height = 8)
...
core_nodes = c('fda0746dace4494eb6cfd64b8b7d6036', '3a6b6eaabaee9f111ba41af0866179ef', '78056058faedd75d706633c5f55a975f', 'd23fbef2f31d48eda40876cdbc49933a')
...
set.seed(76)
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_cluster_network_core_nodes.pdf", width = 14, height = 14)
...
plot(comm_greedy, graph,
     ...
     vertex.label.cex = 1.2,  # Change label size
     ...
     main = "Cow Manure Correlation Network",
     edge.color = "gray")
...
pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_cluster_network_top_hubs.pdf", width = 14, height = 14)
...
plot(comm_greedy, graph,
     ...
     mark.col = adjustcolor(community_colors, alpha.f = 0.4),  # Community boundary color with transparency
     mark.border = community_colors,  # Border of community circles
     main = "cow_manure Correlation Network",
     edge.color = "gray")
...
# set.seed(76)
# pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_ASV_network.pdf", width = 18, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_genus_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_family_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_order_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_class_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_phylum_network.pdf", width = 14, height = 10)
...
write.table(vertices_df_clean, file = file.path("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_vertices.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)


# Edges
edges_df <- igraph::as_data_frame(graph, what = "edges")
write.table(edges_df, file = file.path("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_edges.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)

save.image("/lustre/isaac24/proj/UTK0406/ReeseSaho/projects/bsf_metaa/networks/saho_networks/cow_manure/cow_manure_figures_gen.RData")
