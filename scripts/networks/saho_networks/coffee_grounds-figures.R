...
load("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_network_gen.RData")
...
base_path = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/"
...
cat("Greedy Modularity - coffee_grounds Diet:", mod_greedy)

clust_coef = transitivity(graph, type = "global")

cat("Global Clustering Coefficient - coffee_grounds Diet:", clust_coef)

avg_path_len = mean_distance(graph, directed = FALSE)

cat("Global Average Path Length - coffee_grounds Diet:", avg_path_len)

global_betweenness = betweenness(graph, directed = FALSE, normalized = TRUE)

cat("Mean Global Betweenness - coffee_grounds Diet:", mean(global_betweenness))

global_degree = degree(graph, normalized = TRUE)

cat("Mean Global Degree - coffee_grounds Diet:", mean(global_degree))

global_closeness = closeness(graph, normalized = TRUE)

cat("Mean Global Closeness - coffee_grounds Diet:", mean(global_closeness))

global_eigenvector = eigen_centrality(graph, directed = FALSE)$vector

cat("Mean Global Eigenvector - coffee_grounds Diet:", mean(global_eigenvector))
...
cat("Central Nodes in coffee_grounds Diet:", top_hubs, "\n")
cat("Central Edges in coffee_grounds Diet:", edge_names, "\n")
...
write.table(cumulative_resilience_mod, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/modularity_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_bet, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/betweenness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_close, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/closeness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_deg, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/degree_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_eig, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/eigenvector_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
auc_mixed_product = data.frame(Diet = "coffee_grounds", 
...
write.table(auc_mixed_product, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/metric_auc.tsv", sep = "\t", row.names = FALSE)
...
write.table(auc_table, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/random_auc_table.tsv", sep = "\t", row.names = FALSE)
...
ggsave(
  "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_Modularity_random_bootstrap.pdf",
  random_plot,
...
ggplot(cumulative_resilience_bet, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_global_clust_coef_betweenness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_mod, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_global_clust_coef_modularity.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_deg, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_global_clust_coef_degree.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_eig, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_global_clust_coef_eigenvector.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_close, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_global_clust_coef_closeness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_components.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Components)) +
#   geom_line(color = "blue") +
#   labs(title = "Number of Components During Node Removal", x = "Step (Node Removal)", y = "Number of Components") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_components_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_avg_path_length.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   labs(title = "Average Path Length During Node Removal", x = "Step (Node Removal)", y = "Average Path Length") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_avg_path_length_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_global_clust_coef.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Clustering_Coeff)) +
#   geom_line(color = "green") +
#   labs(title = "Global Clustering Coefficient During Node Removal", x = "Step (Node Removal)", y = "Clustering Coefficient") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_global_clust_coef_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
cat("Robustness AUC - coffee_grounds Diet (degree):", robustness_results_degree$Robustness_Index, "\n")
cat("Robustness AUC- coffee_grounds Diet (betweenness):", robustness_results_betweenness$Robustness_Index, "\n")
...
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_robustness_analysis.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot() +
  ...
  labs(
    title = paste0("Random Removal Robustness Analysis coffee_grounds Diet (Mean AUC: ", round(mean_auc, 4), ")"),
...
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_waste_random_removal_robustness.pdf", device = "pdf", width = 10, height = 8, units = "in")
...
base_path = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/feature_tables/coffee_grounds/"
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_study_network.pdf", width = 10, height = 8)
...
if ("coffee_grounds" == "plant_product" || "coffee_grounds" == "plant_waste") {
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_diet_network.pdf", width = 10, height = 8)
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_cluster_network_core_nodes.pdf", width = 12, height = 8)
...
plot(comm_greedy, graph,
     ...
     main = "coffee_grounds Correlation Network",
     edge.color = "gray")
...
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_cluster_network_top_hubs.pdf", width = 8, height = 8)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_ASV_network.pdf", width = 18, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_genus_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/coffee_grounds/coffee_grounds_family_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_order_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_class_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_phylum_network.pdf", width = 14, height = 10)
...
write.table(vertices_df_clean, file = file.path("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_vertices.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)


# Edges
edges_df <- igraph::as_data_frame(graph, what = "edges")
write.table(edges_df, file = file.path("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_edges.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)

save.image("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/meta_a_networks/mixed_product/mixed_product_figures_gen.RData")
