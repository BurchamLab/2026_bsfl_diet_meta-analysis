...
load("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_network_gen.RData")
...
base_path = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/"
...
write.table(cumulative_resilience_mod, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/modularity_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_bet, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/betweenness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_close, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/closeness_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_deg, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/degree_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
write.table(cumulative_resilience_eig, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/eigenvector_clust_coef.tsv", row.names = FALSE, sep = "\t")
...
auc_variable = data.frame(Diet = "variable", 
...
write.table(auc_variable, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/metric_auc.tsv", sep = "\t", row.names = FALSE)
...
write.table(auc_table, file = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/random_auc_table.tsv", sep = "\t", row.names = FALSE)
...
ggsave(
  "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_Modularity_random_bootstrap.pdf",
  random_plot,
...
ggplot(cumulative_resilience_bet, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_global_clust_coef_betweenness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_mod, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_global_clust_coef_modularity.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_deg, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_global_clust_coef_degree.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_eig, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_global_clust_coef_eigenvector.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggplot(cumulative_resilience_close, aes(x = Percent_Removed, y = Clustering_Coeff)) +
  ...
  theme_minimal()
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_global_clust_coef_closeness.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_components.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Components)) +
#   geom_line(color = "blue") +
#   labs(title = "Number of Components During Node Removal", x = "Step (Node Removal)", y = "Number of Components") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_components_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_avg_path_length.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   labs(title = "Average Path Length During Node Removal", x = "Step (Node Removal)", y = "Average Path Length") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_avg_path_length_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# 
...
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_global_clust_coef.pdf", device = "pdf", height = 8, width = 10, units = "in")
# 
# ggplot(cumulative_resilience_random, aes(x = Step, y = Clustering_Coeff)) +
#   geom_line(color = "green") +
#   labs(title = "Global Clustering Coefficient During Node Removal", x = "Step (Node Removal)", y = "Clustering Coefficient") +
#   theme_minimal()
# ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_global_clust_coef_random.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_robustness_analysis.pdf", device = "pdf", height = 8, width = 10, units = "in")
...
ggsave(filename = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_waste_random_removal_robustness.pdf", device = "pdf", width = 10, height = 8, units = "in")
...
base_path = "/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/feature_tables/variable/"
# base_path = "/Users/burchamlab/Library/CloudStorage/OneDrive-UniversityofTennessee/UTK/Research/Code/bsf_metaa/SparCC-master/variable/subsample/"
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_study_network.pdf", width = 10, height = 8)
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_diet_network.pdf", width = 10, height = 8)
...
set.seed(76)
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_cluster_network_core_nodes.pdf", width = 12, height = 8)
...
pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_cluster_network_top_hubs.pdf", width = 8, height = 8)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_ASV_network.pdf", width = 18, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_genus_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_family_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_order_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_class_network.pdf", width = 14, height = 10)
...
# set.seed(76)
# pdf("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_phylum_network.pdf", width = 14, height = 10)
...
write.table(vertices_df_clean, file = file.path("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_vertices.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)


# Edges
edges_df <- igraph::as_data_frame(graph, what = "edges")
write.table(edges_df, file = file.path("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_edges.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)

save.image("/lustre/isaac24/scratch/rsaho/projects/bsf_metaa/networks/saho_networks/variable/variable_figures_gen.RData")
